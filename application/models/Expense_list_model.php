...
class Expense_list_model extends MY_Model {
    
    public $table = 'expense_list';
    ...
    public function quries()
    {
        ...
        $quries[] = "CREATE TABLE `expense_list` ( `id` int(11) NOT NULL AUTO_INCREMENT, `title` varchar(255) NOT NULL, `status` int(255) NOT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;";
    }
